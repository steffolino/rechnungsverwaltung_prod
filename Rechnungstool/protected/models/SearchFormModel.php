...
class SearchFormModel extends CFormModel
{
   ...
   public $endDate;
	...
	public function searchWithFilter(){
		...
		if(isset($this->jvaName)&& !isset($this->docType) && (!isset($this->startDate) && $this->startDate != "Empty") && (!isset($this->endDate) && $this->endDate != "Empty")){
			...
			$document = Yii::app()->db->createCommand()
					...
					->where('document.docTypeId = docType.docTypeId AND document.jvaId=jvaData.jvaDataId and jvaData.jvaName =:jvaId and documentvalues.documentId = document.documentId',array(':jvaId'=>$this->jvaName))	
					...
					->queryAll();
		}else if(!isset($this->jvaName)&& isset($this->docType) && (!isset($this->startDate)  && $this->startDate != "Empty") && (!isset($this->endDate)  && $this->endDate != "Empty")){
			...
			$document = Yii::app()->db->createCommand()
					...
					->from('document, docType, jvaData, documentvalues')
					->where('document.docTypeId = docType.docTypeId AND document.jvaId=jvaData.jvaDataId and documentvalues.documentId = document.documentId')	
					->andWhere('timestamp>:startDate',array(':startDate'=>$this->startDate))
					->andWhere('contact_person  LIKE :searchTerm OR jvaName LIKE :searchTerm OR value1 LIKE :searchTerm OR value2 LIKE :searchTerm OR value3 LIKE :searchTerm OR value4 LIKE :searchTerm OR value5 LIKE :searchTerm OR value6 LIKE :searchTerm OR value7 LIKE :searchTerm OR value8 LIKE :searchTerm  OR value9 LIKE :searchTerm  OR value10 LIKE :searchTerm  OR value11 LIKE :searchTerm  OR value12 LIKE :searchTerm OR counter LIKE :searchTerm', array(':searchTerm' =>$searchTerm))
					->group('document.documentId')
					->queryAll();
		}else if(!isset($this->jvaName) && !isset($this->docType) && !isset($this->startDate) && isset($this->endDate)){
			...
			$document = Yii::app()->db->createCommand()
					...
					->from('document, docType, jvaData, documentvalues')
					->where('document.docTypeId = docType.docTypeId AND document.jvaId=jvaData.jvaDataId and documentvalues.documentId = document.documentId')	
					->andWhere('timestamp <:endDate',array(':endDate'=>$this->endDate))
					->andWhere('contact_person  LIKE :searchTerm OR jvaName LIKE :searchTerm OR value1 LIKE :searchTerm OR value2 LIKE :searchTerm OR value3 LIKE :searchTerm OR value4 LIKE :searchTerm OR value5 LIKE :searchTerm OR value6 LIKE :searchTerm OR value7 LIKE :searchTerm OR value8 LIKE :searchTerm  OR value9 LIKE :searchTerm  OR value10 LIKE :searchTerm  OR value11 LIKE :searchTerm  OR value12 LIKE :searchTerm OR counter LIKE :searchTerm', array(':searchTerm' =>$searchTerm))
					->group('document.documentId')
					->queryAll();
		}else if(!isset($this->jvaName)&& isset($this->docType) && isset($this->startDate) && isset($this->endDate)){
			...
			$document = Yii::app()->db->createCommand()
					...
					->from('document, docType, jvaData, documentvalues')
					->where('document.docTypeId = docType.docTypeId AND document.jvaId=jvaData.jvaDataId and documentvalues.documentId = document.documentId')	
					->andWhere('timestamp <:endDate',array(':startDate'=>$this->startDate))
					->andWhere('docTypeName =:docType',array(':docType'=>$this->docType))
					->andWhere('contact_person  LIKE :searchTerm OR jvaName LIKE :searchTerm OR value1 LIKE :searchTerm OR value2 LIKE :searchTerm OR value3 LIKE :searchTerm OR value4 LIKE :searchTerm OR value5 LIKE :searchTerm OR value6 LIKE :searchTerm OR value7 LIKE :searchTerm OR value8 LIKE :searchTerm  OR value9 LIKE :searchTerm  OR value10 LIKE :searchTerm  OR value11 LIKE :searchTerm  OR value12 LIKE :searchTerm OR counter LIKE :searchTerm', array(':searchTerm' =>$searchTerm))
					->group('document.documentId')
					->queryAll();
			...
			$document = Yii::app()->db->createCommand()
					->select()
					->from('document, docType, jvaData, documentvalues')
					->where('document.docTypeId = docType.docTypeId document.jvaId=jvaData.jvaDataId and jvaData.jvaName =:jvaId  and documentvalues.documentId = document.documentId',array(':jvaId'=>$this->jvaName))
					->andWhere('timestamp>:startDate AND timestamp <:endDate',array(':startDate'=>$this->startDate, ':endDate'=>$this->endDate))
					->andWhere('docTypeName =:docType',array(':docType'=>$this->docType))
					->andWhere('(contact_person  LIKE :searchTerm OR jvaName LIKE :searchTerm OR value1 LIKE :searchTerm OR value2 LIKE :searchTerm OR value3 LIKE :searchTerm OR value4 LIKE :searchTerm OR value5 LIKE :searchTerm OR value6 LIKE :searchTerm OR value7 LIKE :searchTerm OR value8 LIKE :searchTerm  OR value9 LIKE :searchTerm  OR value10 LIKE :searchTerm  OR value11 LIKE :searchTerm  OR value12 LIKE :searchTerm OR counter LIKE :searchTerm)', array(':searchTerm' =>$searchTerm))
					->group('document.documentId')
